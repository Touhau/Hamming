...
class gui(tk.Frame):
     def __init__(self, window):
        ...
        self.entryText = tk.Label(window, font = 'Arial 12', text = 'Введите двоичное число длиной до 8 символов', bg = '#E2EDE9')

        self.p1lbl = tk.Label(window, font = 'Arial 12', text = 'p1', width = 2, height = 1, bg = '#E2EDE9')
        self.p2lbl = tk.Label(window, font = 'Arial 12', text = 'p2', width = 2, height = 1, bg = '#E2EDE9')
        self.p3lbl = tk.Label(window, font = 'Arial 12', text = 'p3', width = 2, height = 1, bg = '#E2EDE9')
        self.p4lbl = tk.Label(window, font = 'Arial 12', text = 'p4', width = 2, height = 1, bg = '#E2EDE9')
        self.m1lbl = tk.Label(window, font = 'Arial 12', text = 'm1', width = 2, height = 1, bg = '#E2EDE9')
        self.m2lbl = tk.Label(window, font = 'Arial 12', text = 'm2', width = 2, height = 1, bg = '#E2EDE9')
        self.m3lbl = tk.Label(window, font = 'Arial 12', text = 'm3', width = 2, height = 1, bg = '#E2EDE9')
        self.m4lbl = tk.Label(window, font = 'Arial 12', text = 'm4', width = 2, height = 1, bg = '#E2EDE9')
        self.m5lbl = tk.Label(window, font = 'Arial 12', text = 'm5', width = 2, height = 1, bg = '#E2EDE9')
        self.m6lbl = tk.Label(window, font = 'Arial 12', text = 'm6', width = 2, height = 1, bg = '#E2EDE9')
        self.m7lbl = tk.Label(window, font = 'Arial 12', text = 'm7', width = 2, height = 1, bg = '#E2EDE9')
        self.m8lbl = tk.Label(window, font = 'Arial 12', text = 'm8', width = 2, height = 1, bg = '#E2EDE9')
        ...
        self.c1lbl = tk.Label(window, font = 'Arial 12', text = 'c1 =', width = 1, height = 1, bg = '#E2EDE9')
        self.c2lbl = tk.Label(window, font = 'Arial 12', text = 'c2 =', width = 1, height = 1, bg = '#E2EDE9')
        self.c3lbl = tk.Label(window, font = 'Arial 12', text = 'c3 =', width = 1, height = 1, bg = '#E2EDE9')
        self.c4lbl = tk.Label(window, font = 'Arial 12', text = 'c4 =', width = 1, height = 1, bg = '#E2EDE9')
        ...
        self.errorlbl = tk.Label(window, font = 'Arial 12', text = 'Бит', bg = '#E2EDE9')
        self.errorEnt = tk.Entry(window, font = 'Arial 12', width = 2)
        self.errorText = tk.Label(window, font = 'Arial 12', text = 'Допустите 1 ошибку', bg = '#E2EDE9')
